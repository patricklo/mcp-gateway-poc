...
# 数据库: ai_mcp_gateway_test
# 生成时间: 2026-01-02 05:21:27 +0000
# ************************************************************
...
CREATE TABLE `mcp_gateway_auth` (
  ...
  `auth_type` varchar(32) NOT NULL DEFAULT 'full' COMMENT '权限类型：full-完全权限，readonly-只读',
...
INSERT INTO `mcp_protocol_mapping` (`id`, `tool_id`, `mapping_type`, `parent_path`, `field_name`, `mcp_path`, `mcp_type`, `mcp_desc`, `is_required`, `http_path`, `http_location`, `sort_order`, `create_time`, `update_time`)
VALUES
